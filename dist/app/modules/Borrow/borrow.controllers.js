...
const createBorrowRecord = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield borrow_services_1.borrowRecordServices.createBorrowRecordIntoDB(req.body);
...
const getOverDue = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield borrow_services_1.borrowRecordServices.getOverDueFromDB();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
